...
import { KNOCK_STATUS_IDS } from '@/app/types/disposition';
...
export default function Home() {
  ...
  const goodLeads = roleFilteredLeads.filter(l => l.solarCategory !== 'poor' || (l.status && (KNOCK_STATUS_IDS as readonly string[]).includes(l.status)));
  const poorLeads = roleFilteredLeads.filter(l => l.solarCategory === 'poor' && (!l.status || !(KNOCK_STATUS_IDS as readonly string[]).includes(l.status)));
