          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 border border-[#E2E8F0]">
            ...
            <div className="mt-6 flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-blue-500 text-white font-semibold flex items-center gap-2 hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Create Team
              </button>
            </div>
